      ...
      <div className="delete-modal-box" onClick={(e) => e.stopPropagation()}>
        <div className="delete-modal-icon-container">
          <svg
            ...
            className="delete-modal-svg-icon"
          >
        ...
        <div className="delete-modal-actions">
          ...
          <button className="delete-modal-btn delete-btn" onClick={onConfirm}>
            Xóa
          </button>
        </div>
      </div>
...
function ServiceTable({ services, onEdit, onDelete, currentUserRole }) {
  ...
  // CHUẨN HÓA DỮ LIỆU ĐỂ HIỂN THỊ (ĐÃ BỎ CATEGORY)
  ...
  return (
    <div className="table-container">
                ...
                <td className="text-center">
                  <span
                    className={`status-badge ${
                      service.displayStatus ? "active" : "inactive"
                    }`}
                  >
      ...
      <DeleteServiceModal
        ...
        serviceName={serviceToDelete?.displayName || ""}
      />
    </div>
  );
}
